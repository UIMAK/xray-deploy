...
_with_core_lock() {
    ...
    local legacy_lockf legacy_fallback_dir legacy_fresh=0 i locked=0 rc owner
...
_with_deploy_install_lock() {
    ...
    local legacy_lock_file legacy_lock_dir legacy_fresh=0 DEPLOY_INSTALL_LOCK_FD="" i locked=0 owner tmp rc
